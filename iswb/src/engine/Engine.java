...
/**
 * Questa � la classe principale e si occupa di simulare le due macchine.
 * <br>
...
public class Engine 
{
	 ...
	 * dovr� essere usata per computare i passi di simulazione validi.
	 * 
	 ...
	 * <br>
	 * In particolare quindi conterr� tutte le transazioni attive che non
	...
	public List<PassoSimulazione> getPassiAttivi()
	{
		...
		//se non � stata impostata la matrice di relazioni ritorniamo la lista
